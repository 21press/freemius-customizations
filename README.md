...
```
https://cdn.jsdelivr.net/gh/21press/freemius-customizations@v10/account.css
```
...
2. Create the next tag on that commit:
   ...
   ```
3. Update the URL in the Freemius dashboard to `@v10`. One character.
...
curl -s "https://cdn.jsdelivr.net/gh/21press/freemius-customizations@v10/account.css" | wc -c
```
...
```
https://cdn.jsdelivr.net/gh/21press/freemius-customizations@v10/account.js
```
